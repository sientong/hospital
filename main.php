...
define('global_project_name', 'hospitalManagementSystem');
define('global_project_version', '1.0');
define('global_project_website', 'http://localhost/hospital/');
...
define('global_mysql_configuration_table', 'hms_configuration');
define('global_mysql_users_table', 'hms_user');

// Cookies

define('global_cookie_prefix', 'hospital_');
...
// define('global_first_hall_price', get_configuration('first_hall_price'));
